...
module.exports = class WhiskerApp extends Homey.App {
  ...
  _registerLitterRobotFlowCards() {
    ...
    this.homey.flow
      ...
      .registerRunListener(this._litterRobotArgActionRunListener.bind(this, 'night_light_mode', 'mode', undefined, undefined));
    ...
    this.homey.flow
      ...
      .registerRunListener(this._litterRobotArgActionRunListener.bind(this, 'clean_cycle_wait_time', 'wait_time', undefined, undefined));

    this.homey.flow
      .getActionCard('set_panel_brightness')
      .registerRunListener(this._litterRobotArgActionRunListener.bind(this, 'panel_brightness', 'brightness', undefined, undefined));

    this.homey.flow
      .getActionCard('set_night_light_brightness')
      .registerRunListener(this._litterRobotArgActionRunListener.bind(this, 'night_light_brightness', 'brightness', undefined, undefined));
